...
export const createRpgState = (): RpgState => ({ activeSceneId: 'terminal-square', unlockedSceneIds: ['terminal-square'], encounterStatus: 'exploring', coachText: null, player: { x: 4, y: 3 } });
